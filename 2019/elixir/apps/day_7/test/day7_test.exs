defmodule Day7Test do
  ...
  test "simple thruster signals" do
    assert Day7.run_amplifier_controller_software(
  ...
  test "thruster signals with feedback loop" do
    assert Day7.run_amplifier_controller_software(
  ...
  test "process part 2" do
    assert Day7.process_part2(Util.get_input()) === 14_897_241
  end
end
